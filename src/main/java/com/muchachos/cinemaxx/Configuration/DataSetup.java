...
public class DataSetup implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
       ...
       // Movie movie5 = movieRepo.save(new Movie(null, "Queen of Katwe", "PG", "Madina Nalwanga", "Inspiring", 124, "https://www.youtube.com/watch?v=z4l3-_yub5A", "https://m.media-amazon.com/images/M/MV5BNzQ0MDg2NTY4N15BMl5BanBnXkFtZTgwOTk2NzU3OTE@._V1_.jpg", "https://m.media-amazon.com/images/M/MV5BMjc2MmU4NDYtNDA5OS00ZDgxLWE1MjMtMjA2OGMyODczODA2XkEyXkFqcGdeQXVyNjAwNTYwNDg@._V1_.jpg"));
        ...
        screenings.add(new CreateScreeningRequest(1, 1, LocalDateTime.of(2021, 12, 21, 21, 0)));
        screenings.add(new CreateScreeningRequest(2, 2, LocalDateTime.of(2021, 12, 21, 18, 0)));
        screenings.add(new CreateScreeningRequest(3, 3, LocalDateTime.of(2021, 12, 21, 20, 0)));
        screenings.add(new CreateScreeningRequest(4, 4, LocalDateTime.of(2021, 12, 21, 21, 0)));
        screenings.add(new CreateScreeningRequest(5, 5, LocalDateTime.of(2021, 12, 21, 18, 0)));
        // screenings.add(new CreateScreeningRequest(6, 6, LocalDateTime.of(2021, 12, 19, 16, 0)));
        //screenings.add(new CreateScreeningRequest(7, 7, LocalDateTime.of(2021, 12, 20, 20, 0)));
        //screenings.add(new CreateScreeningRequest(8, 8, LocalDateTime.of(2021, 12, 20, 19, 0)));
